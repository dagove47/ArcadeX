...
namespace ArcadeX.BaseDatos
{
    ...
    public partial class ArcadeXEntities1 : DbContext
    {
        public ArcadeXEntities1()
            : base("name=ArcadeXEntities1")
        {
        }
        ...
        public virtual int RegistrarCliente(string identificacion, string nombre, string email, string contrasenna, Nullable<int> rolID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegistrarCliente", identificacionParameter, nombreParameter, emailParameter, contrasennaParameter, rolIDParameter);
        }
    }
}
